...
window.addEventListener('load', () => {
    ...
    TL.staggerFrom(img, 1, { x: 1000, opacity: 0, ease: "power2.out" }, 0.3)
    TL.staggerFrom(title_span, 1, { opacity: 0, ease: "power2.out" }, 0.1)
    TL.staggerFrom(p, 1, { opacity: 0, ease: "power2.out" }, 0.2)
    TL.staggerFrom(a, 1, { opacity: 0, ease: "power2.out" }, 0.3)
    TL.play()
})
